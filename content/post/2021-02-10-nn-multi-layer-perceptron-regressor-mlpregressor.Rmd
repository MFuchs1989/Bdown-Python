...
![](/post/2021-02-10-nn-multi-layer-perceptron-regressor-mlpregressor_files/p111p.png)
...
In two subsequent posts, I will show how to perform classifications and regressions using the deep learning library [Keras](https://keras.io/) and then compare the results with those of the MLP models. 
