...
Now we get a detailed overview of the initialized setup and the performed transformation steps of the pipeline. 
...
Use these preprocessing and transformation parameters in the setup as needed for your present data set. 

In my example I leave it at the default settings. Using the get_config function we can view the edited record. 
