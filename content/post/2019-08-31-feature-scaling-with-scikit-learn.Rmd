...
You can also save yourself a step in the syntax if you don't use the fit & transform function individually but together.
...
The scaling methods presented above can be divided into two categories: **Normalization** and **Normalization**
