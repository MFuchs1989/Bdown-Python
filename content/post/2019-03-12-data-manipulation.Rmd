...
We want to check the names where the columns 'Gehalt' is NaN. 
...
The code below shows a selective selection of the name (here Moni) for which no age is available, and then replaces the salary with 3.000 for this hit.
