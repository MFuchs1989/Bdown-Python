...
Of course, we can also output the highest values. This is useful, for example, if you want to compare the performance values of algorithms during model training. 

```{r, eval=F, echo=T}
highest_values_df = negative_values_df.copy()

highest_values_df.style.highlight_max(color = 'lightgreen', axis = 0)
```
