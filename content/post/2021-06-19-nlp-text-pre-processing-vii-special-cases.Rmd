...
However, before we get to removing special characters or numbers (or converting them to words) we should still convert emoticons words. 
...
![](/post/2021-06-19-nlp-text-pre-processing-vii-special-cases_files/p130p32.png)
