...
How to create a neronal net with this library for classification I want to show in this post. 

For this publication the datasets *Winequality* and *Iris* from the statistic platform ["Kaggle"](https://www.kaggle.com/c/santander-customer-satisfaction/data) were used. You can download them from my ["GitHub Repository"](https://github.com/MFuchs1989/Datasets-and-Miscellaneous/tree/main/datasets). 
...
# 4 MLPClassifier for Multi-Label Classification

With an MLP, multi-label classifications can of course also be carried out. 
...
In this post, I showed how to build an MLP model to solve binary and multi-label classification problems. 
