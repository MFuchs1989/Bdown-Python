...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p2.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p3.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p4.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p5.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p6.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p7.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p8.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p9.png)

![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p10.png)


![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p11.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p12.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p13.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p14.png)
...
![](/post/2021-06-16-nlp-text-pre-processing-vi-word-removal_files/p129p15.png)
...
Finally, we generated the column 'Reviews_cleaned_wo_rare_words', where we excluded the word 'phone' and 2500 other words that occurred only once in the entire text corpus. Now we need to vectorize the individual text columns to make them usable for machine learning algorithms. 
