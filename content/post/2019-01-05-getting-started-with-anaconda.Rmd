...
In our demp_env I installed the following basic libraries:
...
### 5.1.1 Installing jupyter_contrib_nbextensions

Here, the installation is not quite so trivial. Therefore I list the commands for the installation of the jupyter_contrib_nbextensions separately:
...
### 5.1.2 Update existing libraries**
...
If you want to have the created sample environment feel free to download it from my [GitHub Repository](https://github.com/MFuchs1989/Bdown-Python/tree/master/datasets/environment).
