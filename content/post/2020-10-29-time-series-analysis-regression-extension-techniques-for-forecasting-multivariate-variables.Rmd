...
for feature in train_diff:
    ...
    plt.xlabel("Date")
    plt.ylabel(feature)
    plt.title(f"{str(feature)} price of Facebook stocks after stationary")
    plt.show()
```

![](/post/2020-10-29-time-series-analysis-regression-extension-techniques-for-forecasting-multivariate-variables_files/p97p8.png)

![](/post/2020-10-29-time-series-analysis-regression-extension-techniques-for-forecasting-multivariate-variables_files/p97p9.png)
...
![](/post/2020-10-29-time-series-analysis-regression-extension-techniques-for-forecasting-multivariate-variables_files/p97p10.png)


![](/post/2020-10-29-time-series-analysis-regression-extension-techniques-for-forecasting-multivariate-variables_files/p97p11.png)
...
for a,b in enumerate(pg):
    ...
    openrmse = np.sqrt(metrics.mean_squared_error(testX.Open, inv_res.Open_1st_inv_diff))
