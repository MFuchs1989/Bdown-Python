...
#for chapter 3.3 ANPASSUNG 
from sklearn.feature_selection import RFE

#for chapter 3.3 and 5.2ANPASSUNG
from sklearn.linear_model import LogisticRegression

#for chapter 4ANPASSUNG
import statsmodels.api as sm

#for chapter 5.1ANPASSUNG
from imblearn.over_sampling import SMOTE

#for chapter 5.3ANPASSUNG
...
To evaluate classification models we usualy use a confusion matrix.
This can be requested in python as follows: 
...
Or in this way (maybe a little more appealing):
...
print('Precision: {:.2f}'.format(metrics.precision_score(testY_final, y_pred)))
print('Recall: {:.2f}'.format(metrics.recall_score(testY_final, y_pred)))
print('f1_score: {:.2f}'.format(metrics.f1_score(testY_final, y_pred)))
```
...
metrics.roc_auc_score(testY_final, y_pred_proba)
```
