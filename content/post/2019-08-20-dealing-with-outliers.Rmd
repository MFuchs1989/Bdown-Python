...
In addition to the Z-score method, outliers can also be identified using the IQR method. This has the advantage that it uses robust parameters for the calculation.
