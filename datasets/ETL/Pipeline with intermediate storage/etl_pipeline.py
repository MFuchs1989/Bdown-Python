...
class DataPreprocessor:
    def __init__(self, path_folder = "C:/Users/Michael Fuchs/OneDrive - CANCOM GmbH/3_General/Python/Jupyter Script/Backlog/ETL/ETL Step by Step/5 ETL - Pipeline with intermediate storage/data"):
